...
class Reserva:
    ...
    def confirmar(self):
        ...
        registrar_log("INFO", f"Reserva confirmada: {self.cliente.nombre}")
        
    def cancelar(self):
        self.estado = "Cancelada"
        registrar_log("INFO", f"Reserva cancelada: {self.cliente.nombre}") 
    ...
    def procesar(self):
        try:
            ...
            registrar_log("INFO", f"Reserva procesada: {self.cliente.nombre}")
